    ...
    cell: ({ row }) => {
      ...
      const postdata = async (data) => {
        const response = await axios.post(
          `https://nextapplicatin.iran.liara.run/api/update-categories/${row.getValue("_id")}`,data,configss);
        return response;
      };
      ...
      const deletedata = async () => {
        const response = await axios.post(
          `https://nextapplicatin.iran.liara.run/api/delete-categories/${row.getValue("_id")}`,{item:1} , configss 
        );
        return response;
      };
      ...
      const delbanner = () => {
        querydatadel.mutateAsync(configss);
      };
